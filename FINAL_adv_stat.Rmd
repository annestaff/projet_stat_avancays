...
Where \$ \Theta \subseteq R\^d \$ is a parameter space, so the
parametric hypothesis is admitted.
...
# so we saved ther esult as a csv and load it for the graph and for knitting this
#
